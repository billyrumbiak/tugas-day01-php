...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Hasil Kerja Section ======= -->
    <?php
      if(isset($_GET['page']) && $_GET['page'] == 'hasil-kerja') {
        include('views/pages/hasil-kerja.php');
      }
    ?>

    <!-- ======= Rekan Kerja Section ======= -->
    <?php 
      if(isset($_GET['page']) && $_GET['page'] == 'rekan-kerja') {
        include('views/pages/rekan-kerja.php');
      } 
    ?>
